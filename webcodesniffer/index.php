...
<div class='title'><img src='codesniffer/wcs_images/wcs.png' width='120' height='54' alt='Web CodeSniffer' />0.1<span class="infobulle"><a class="info" href="#">?<span>WebCodeSniffer is a web version of PHP_CodeSniffer. No PEAR, no CLI needed. PHP_CodeSniffer is a PHP5 script that tokenises PHP, JavaScript and CSS files to detect violations of a defined set of coding standards. It is an essential development tool that ensures your code remains clean and consistent. It can also help prevent some common semantic errors made by developers.</span></a></span></div>
</div>
<div class='top_right'>
<?php
// Notification
